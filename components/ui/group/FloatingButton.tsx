...
const FloatingButton = ({ group }: FloatingButtonProps) => {
        ...
        <View style={styles.container} pointerEvents="box-none">
            ...
            <View style={styles.buttonContainer} pointerEvents="box-none">
                ...
                <Animated.View style={[styles.buttonWrapper, expenseStyle]}>
                    ...
                    >
                        <MaterialCommunityIcons name="account-plus-outline" size={24} color="#2196F3" />
                        <View style={styles.labelContainer}>
                            <Text style={styles.buttonLabel}>New Person</Text>
                        </View>
                    </TouchableOpacity>
                </Animated.View>
